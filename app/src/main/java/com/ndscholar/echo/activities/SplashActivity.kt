    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        when(requestCode)
        {
            131->{
                ...
                {
                    Toast.makeText(this@SplashActivity,"Grant All Permission",Toast.LENGTH_SHORT).show()
                    this.finish()
                }
                return
            }
            ...
            {
                Toast.makeText(this@SplashActivity,"Somthing went wrong",Toast.LENGTH_SHORT).show()
                this.finish()
                return
            }
